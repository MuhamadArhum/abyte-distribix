...
const superAdminGroup: NavGroup = {
  ...
  items: [
    ...
    {
      // Backup/restore acts on the single shared database file underneath
      // every tenant, so it's a platform-level operation, not a per-company
      // ADMIN one — kept out of the regular System group for that reason.
