...
export class RolesController {
  ...
  @Post() create(@Body() body: CreateRoleDto, @Request() req: any) { return this.rolesService.create(body, req.user?.companyId, req.user?.userId); }
  @Patch(':id') update(@Param('id') id: string, @Body() body: UpdateRoleDto, @Request() req: any) { return this.rolesService.update(id, body, req.user?.companyId, req.user?.userId); }
